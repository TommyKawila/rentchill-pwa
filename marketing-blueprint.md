...
**Status:** ใช้ LINE ส่วนตัวปนกับงาน จำไม่ได้ว่าใครจ่ายแล้ว

**Message:** The Personal Assistant — แยกงานออกจากชีวิตส่วนตัว

**Pain:** ทวงบิลยาก ไล่เช็คสลิปทีละแชท ลืมว่าใครค้าง
...
**Typography:** Sans-serif อ่านง่าย White Space เยอะ
