    ...
    <section className="rounded-xl border border-zinc-100 bg-white p-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 text-xs text-zinc-500">
          <span className="inline-flex items-center gap-1">
            <span className="h-2 w-2 rounded-sm bg-rc-success" />
            {t("owner.analytics.chart.revenue")}
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="h-2 w-2 rounded-sm bg-rc-danger" />
      ...
      {active && (
        <div className="mt-4 rounded-lg border border-zinc-100 bg-zinc-50 p-4">
          ...
          <p className="mt-2 text-sm text-rc-success">
            {t("owner.analytics.chart.revenue")}: ฿{formatAmount(active.revenue)}
          </p>
          <p className="text-sm text-rc-danger">
