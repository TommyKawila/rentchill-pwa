...
export function OwnerToolsMenuSkin({
  ...
  const itemClass =
    "block w-full rounded-md px-3 py-2 text-left text-xs font-medium text-zinc-700 hover:bg-zinc-50 disabled:opacity-50";
  ...
  return (
    <div ref={rootRef} className="relative min-w-0 flex-1">
      <button
        ...
        className="w-full rounded-full border border-zinc-300 bg-white px-3 py-1.5 text-xs font-medium text-zinc-700"
      >
        {t("owner.nav.tools")} ▾
      </button>

      {open && (
        <div className="absolute left-0 right-0 z-20 mt-1 rounded-lg border border-zinc-200 bg-white p-1 shadow-sm">
